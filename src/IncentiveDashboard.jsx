...
export default function MultiIncentiveDashboard() {
  ...
  async function addOnly(incentive) {
    ...
    if (!supabase) return;
    await supabase.from("contributions").insert({ incentive_id: incentive.id, amount: val, note });
  }
          ...
          {[...activityIncs, ...(sales2 ? [sales2] : [])].map((inc) => (
            ...
            >
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 8 }}>
                ...
                />
                <button onClick={() => addOnly(inc)} style={btnStyle("#FAA03C")} title="Add">
              ...
              <input
                type="text"
                placeholder="Initials/What's added"
                value={notes[inc.id] || ""}
